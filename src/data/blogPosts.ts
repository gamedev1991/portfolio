...
export const blogPosts: BlogPost[] = [
  {
    ...
    link: "/blog/how-i-became-a-product-manager", // Changed from external to internal link
...
With the onset of COVID-19 and the high costs of an MBA, I looked for a course that I could do along with my work, where I wouldn't have to lose out on work experience and learn the skills required for a product management role. Upgrad offered the course of product management and sounded perfect. In May 2019, I enrolled in the course, and my journey to transition to a product manager started. After 6 months of learning, watching content videos, assignments, and two industry projects along with working full time remotely, I earned the product management certificate and had learned the skills (market research, user research, user personas, prototyping, product analysis, roadmaps) that would be required for a product manager role. Here's a tip: Make your assignments and industry project in such a way that you can post on LinkedIn, it will help boost your profile. Little did I know that just learning the skills and a certificate for the same is not enough.

While Upgrad and most other institutions offer placement assistance, that doesn't mean you will get a job. All these institutions will only help in your applications to the various product management roles and at most can refer your profile if they have alumni in the company you wish to apply to, but they will definitely help in grooming your resume and LinkedIn profile. They will also set up mentorship calls and mock interviews but you will have to apply to all jobs on your own thus started my endless cycle of applying to jobs and getting rejected. Here's a pie chart of the applications I sent:
...
I applied to a total of 188 jobs where I did not get any response for 83% of my applications. Here Upgrad's career coach helped me stay motivated and keep applying. He also asked me to keep applying for jobs and iterate my resume and profile. Here's another tip for anyone who wants to transition: Make sure you have enough points in your work experience for the new role you want to transition to, otherwise you are going to go through the same ordeal. Out of the 188 companies I applied to, 32 companies responded and I am grateful for their responses. My major disappointment was that I was getting rejected without any feedback, luckily my profile did get considered in 7 companies of which I was able to get the job offer only from one company.

I am happy to announce that I have joined Playshifu on 5 July 2021, Playshifu is one of the few companies that believe in the attitude of their employees and not just work experience, being a startup themselves they are ready to hire people with the same drive and values that the company has. I look forward to the role and the challenges that come along with the same.
    `
  },
  {
